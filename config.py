...
# Веса источников (чем выше, тем выше приоритет новости при публикации)
SOURCE_PRIORITY_WEIGHTS = {
    ...
    'РБК Экономика': 1.15,
    'BBC Russian': 1.1,
    'Независимая газета': 1.05,
    'Российская Газета Мир': 1.0
}

# Ключевые маркеры повышенной важности
IMPORTANT_NEWS_KEYWORDS = [
    'санкц', 'чрезвычайн', 'военное положение', 'мобилизац', 'референдум',
    'переговор', 'саммит', 'договор', 'законопроект', 'закон принят',
    'указ', 'ратифиц', 'перемир', 'ceasefire', 'атака', 'удар', 'обстрел'
]

# Базовые веса тем: влияют на итоговый приоритет публикации
...
# Ограничения и коэффициенты ранжирования
MAX_IMPORTANT_KEYWORD_BONUS = 2.5
FRESHNESS_HALF_LIFE_HOURS = 6
MAX_FRESHNESS_BONUS = 3.0
